...
public class ProcessSonarWayProfile extends ProfileDefinition {
	  ...
	  public RulesProfile createProfile(ValidationMessages messages) {
	    return annotationProfileParser.parse(ProcessRuleDefinition.REPOSITORY_KEY, defaultProfileName, BWProcessLanguage.KEY, ProcessRuleDefinition.checkRules, messages);
	  }
