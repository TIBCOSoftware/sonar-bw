...
package com.tibco.sonar.plugins.bw5.check.activity.jms.topic.publisher;
...
@Rule(key = HardCodedDestinationCheck.RULE_KEY, name = CheckConstants.RULE_PROCESS_JMSTOPICPUBLISHERDESTINATIONHARDCODED_NAME, description =  CheckConstants.RULE_PROCESS_JMSTOPICPUBLISHERDESTINATIONHARDCODED_DESCRIPTION, priority = Priority.MAJOR,tags={"bug"}, cardinality = Cardinality.SINGLE)
public class HardCodedDestinationCheck extends AbstractProcessHardCodedCheck {
	...
	public static final String RULE_KEY = "JMSTopicPublisherDestinationHardCoded";
	
	protected static final String CONFIG_XPATH_DEFAULT = "//SessionAttributes/destination";
	protected static final String INPUTBINDING_XPATH_DEFAULT = "//*[local-name()='ActivityInput']/destinationTopic";
	protected static final String ACTIVITY_TYPE_DEFAULT = "com.tibco.plugin.jms.JMSTopicPublishActivity";
	protected static final String MESSAGE_DEFAULT = "Destination hard coded in JMS Topic Publisher activity";
