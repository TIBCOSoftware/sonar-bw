...
public class NumberofActivitiesCheck extends AbstractProcessCheck {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NumberofActivitiesCheck.class);
    ...
    protected void validate(ProcessSource processSource) {
        ...
        LOG.debug("Number of activities for process: ["+process.getName()+"]: "+activityCount);
        if (activityCount > maxActivities) {
            reportIssueOnFile("The process " + process.getName() + " has too many activities ["+activityCount+"], this reduces the process readablity");
        }
