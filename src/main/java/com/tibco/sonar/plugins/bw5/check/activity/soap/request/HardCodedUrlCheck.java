...
@Rule(key = HardCodedUrlCheck.RULE_KEY, name = CheckConstants.RULE_PROCESS_SOAPREQUESTURLHARDCODED_NAME ,  description =  CheckConstants.RULE_PROCESS_SOAPREQUESTURLHARDCODED_DESCRIPTION, priority = Priority.MAJOR)
