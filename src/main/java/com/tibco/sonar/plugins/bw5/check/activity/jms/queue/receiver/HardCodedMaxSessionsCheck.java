...
@Rule(key = HardCodedMaxSessionsCheck.RULE_KEY, name = CheckConstants.RULE_PROCESS_JMSQUEUERECEIVERMAXSESSIONSHARDCODED_NAME, description = CheckConstants.RULE_PROCESS_JMSQUEUERECEIVERMAXSESSIONSHARDCODED_DESCRIPTION, priority = Priority.MAJOR,tags={"bug"})
public class HardCodedMaxSessionsCheck extends AbstractProcessHardCodedCheck {

    private static final Logger LOG = LoggerFactory.getLogger(HardCodedMaxSessionsCheck.class);
	...
	protected static final String MESSAGE_DEFAULT = "Max Sessions hard coded in JMS Queue Receiver activity";
