...
@Rule(key = HardCodedDestinationCheck.RULE_KEY, name = CheckConstants.RULE_PROCESS_JMSQUEUERECEIVERDESTINATIONHARDCODED_NAME, description = CheckConstants.RULE_PROCESS_JMSQUEUERECEIVERDESTINATIONHARDCODED_DESCRIPTION, priority = Priority.MAJOR,tags={"bug"}, cardinality = Cardinality.SINGLE)
