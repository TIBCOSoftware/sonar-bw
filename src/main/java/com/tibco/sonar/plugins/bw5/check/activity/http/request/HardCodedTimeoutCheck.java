...
@Rule(key = HardCodedTimeoutCheck.RULE_KEY, name = CheckConstants.RULE_PROCESS_HTTPREQUESTTIMEOUTHARDCODED_NAME, description = CheckConstants.RULE_PROCESS_HTTPREQUESTTIMEOUTHARDCODED_DESCRIPTION, priority = Priority.MAJOR,tags={"bug"})
