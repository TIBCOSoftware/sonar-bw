...
public class HardCodedSoapActionCheck extends AbstractProcessHardCodedCheck {
	...
	public static final String RULE_KEY = "SOAPReceiverSoapActionHardCoded";
	
	protected static final String CONFIG_XPATH_DEFAULT = "//soapAction";
	protected static final String INPUTBINDING_XPATH_DEFAULT = "";
	protected static final String ACTIVITY_TYPE_DEFAULT = "com.tibco.plugin.soap.SOAPEventSource";
	protected static final String MESSAGE_DEFAULT = "Soap Action hard coded in SOAP Receiver activity";
