...
@Rule(key = HardCodedPortCheck.RULE_KEY, 
	  name = CheckConstants.RULE_PROCESS_HTTPREQUESTPORTHARDCODED_NAME,
	  description = CheckConstants.RULE_PROCESS_HTTPREQUESTPORTHARDCODED_DESCRIPTION, 
...
public class HardCodedPortCheck extends AbstractProcessHardCodedCheck {
	...
	protected static final String INPUTBINDING_XPATH_DEFAULT = "//RequestActivityInput/Port";
	protected static final String ACTIVITY_TYPE_DEFAULT = "com.tibco.plugin.http.client.HttpRequestActivity";
	protected static final String MESSAGE_DEFAULT = "Port hard coded in HTTP Request Reply activity";
