...
public class SapFileSinkFileLimitHardcodingCheck extends AbstractXmlCheck {
	...
	public static final String FILE_LIMIT_ELEMENT_NAME = "AESDK:fileLimit";
	...
	protected void validateXml(XmlBw5Source xmlSource) {
		if("adr3".equals(xmlSource.getExtension())) {
			...
			try {
				...
				xmlSource.findAndValidateHardCodedChild(getRuleKey(), (Element)fileSinkElement, FILE_LIMIT_ELEMENT_NAME,
