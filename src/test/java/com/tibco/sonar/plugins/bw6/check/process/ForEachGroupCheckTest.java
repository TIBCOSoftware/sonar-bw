 ...
 * @author avazquez
 */
public class ForEachGroupCheckTest {
    
    private static ProcessSource source;
    
    public ForEachGroupCheckTest() {
    }
    ...
    public static void setUpClass() {
            ...
            source = new ProcessSource("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                    ...
                    "                </tibex:receiveEvent>\n" +
                    "            </bpws:extensionActivity>\n" +
                    "            <bpws:scope name=\"ForEach\" tibex:group=\"foreach\"\n" +
                    "                tibex:indexToGlobal=\"false\" tibex:xpdlId=\"6c7ed04f-a86a-4875-8443-8db36469cb80\">\n" +
                    "                <bpws:targets>\n" +
                    ...
                    "                                tibex:group=\"groupEnd\" tibex:xpdlId=\"94ef1193-e2be-4cfc-b017-53135955c10d\">\n" +
                    "                                <bpws:targets>\n" +
    ...
    public void testValidate() {
        ...
        ForEachGroupCheck instance = new ForEachGroupCheck();
        ForEachGroupCheck spyInstance = Mockito.spy(instance);
