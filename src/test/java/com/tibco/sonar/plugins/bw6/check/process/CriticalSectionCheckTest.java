 ...
 * @author avazquez
 */
public class CriticalSectionCheckTest {
    
    private static ProcessSource source;
    public CriticalSectionCheckTest() {
    }
    ...
    public void testValidate() {
        ...
        ProcessSource source2 = new ProcessSource("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "                            <tibex:inputBindings>\n" +
                "                                <tibex:inputBinding\n" +
                "                                    expression=\"&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?> &lt;xsl:stylesheet xmlns:xsl=&quot;http://www.w3.org/1999/XSL/Transform&quot; xmlns:tns=&quot;http://tns.tibco.com/bw/activity/sleep/xsd&quot; version=&quot;2.0&quot;> &lt;xsl:template name=&quot;Sleep-input&quot; match=&quot;/&quot;> &lt;tns:SleepInputSchema/>&lt;/xsl:template> &lt;/xsl:stylesheet>\" expressionLanguage=\"urn:oasis:names:tc:wsbpel:2.0:sublang:xslt1.0\"/>\n" +
                "                            </tibex:inputBindings>\n" +
                "                            <tibex:config>\n" +
                "                                <bwext:BWActivity\n" +
                ...
                "    </bpws:scope>\n" +
                "</bpws:process>");
        spyInstance.validate(source2);        
        System.out.println(source2.getProcessModel().getGroupcount());
