 ...
 * @author avazquez
 */
public class RenderXMLBinaryCheckTest {
    
    public RenderXMLBinaryCheckTest() {
    }
...
"</bpws:process>");
    ...
    public void testValidate() {
        ...
        RenderXMLBinaryCheck instance = new RenderXMLBinaryCheck();
        RenderXMLBinaryCheck spyInstance = Mockito.spy(instance);
