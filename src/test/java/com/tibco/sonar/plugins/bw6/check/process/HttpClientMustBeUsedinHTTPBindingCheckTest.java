 ...
 * @author avazquez
 */
public class HttpClientMustBeUsedinHTTPBindingCheckTest {
    
    public HttpClientMustBeUsedinHTTPBindingCheckTest() {
    }
...
"</bpws:process>");
    ...
    public void testValidate() {
        ...
        HttpClientMustBeUsedinHTTPBindingCheck instance = new HttpClientMustBeUsedinHTTPBindingCheck();
        HttpClientMustBeUsedinHTTPBindingCheck spyInstance = Mockito.spy(instance);
