 ...
 * @author avazquez
 */
public class ExceptionHandlingCheckTest {

    private static ProcessSource source;
    
    public ExceptionHandlingCheckTest() {
    }
...
"    targetNamespace=\"http://xmlns.example.com/20190304141350\"\n" +
...
"        createdOn=\"Mon Mar 04 14:13:50 CET 2019\" description=\"\"\n" +
...
"        <bpws:flow name=\"flow\">\n" +
"            <bpws:links>\n" +
"                <bpws:link name=\"TimerToExit\" tibex:linkType=\"SUCCESS\"/>\n" +
"            </bpws:links>\n" +
"            <bpws:extensionActivity>\n" +
"                <tibex:receiveEvent createInstance=\"yes\"\n" +
"                    eventTimeout=\"60\" name=\"Timer\"\n" +
"                    tibex:xpdlId=\"3ff22558-51ec-4e36-8d75-6119b219d445\"\n" +
"                    variable=\"Timer\" xmlns:tibex=\"http://www.tibco.com/bpel/2007/extensions\">\n" +
"                    <bpws:sources>\n" +
"                        <bpws:source linkName=\"TimerToExit\"/>\n" +
"                    </bpws:sources>\n" +
"                    <tibex:eventSource>\n" +
"                        <bwext:BWActivity\n" +
...
"                                    <value\n" +
"                                    endTime=\"2019-03-04T14:14:05.051+0100\"\n" +
"                                    intervalUnit=\"Second\"\n" +
"                                    runOnce=\"true\"\n" +
"                                    startTime=\"2019-03-04T14:14:05.051+0100\"\n" +
...
"                </tibex:receiveEvent>\n" +
"            </bpws:extensionActivity>\n" +
"            <bpws:exit name=\"Exit\" tibex:xpdlId=\"968e032f-8455-4a9c-a838-26eea2303d99\">\n" +
"                <bpws:targets>\n" +
"                    <bpws:target linkName=\"TimerToExit\"/>\n" +
"                </bpws:targets>\n" +
"            </bpws:exit>\n" +
"        </bpws:flow>\n" +
"    </bpws:scope>\n" +
"</bpws:process>");
    ...
    public void testValidate() {
        ...
        ExceptionHandlingCheck instance = new ExceptionHandlingCheck();
        ExceptionHandlingCheck spyInstance = Mockito.spy(instance);
