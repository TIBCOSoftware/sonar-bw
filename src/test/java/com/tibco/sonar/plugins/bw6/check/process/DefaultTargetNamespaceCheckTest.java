 ...
 * @author avazquez
 */
public class DefaultTargetNamespaceCheckTest {

    private static ProcessSource source;
    
    public DefaultTargetNamespaceCheckTest() {
    }
...
"</bpws:process>");
    ...
    public void testValidate() {
        ...
        DefaultTargetNamespaceCheck instance = new DefaultTargetNamespaceCheck();
        DefaultTargetNamespaceCheck spyInstance = Mockito.spy(instance);
