 ...
 * @author avazquez
 */
public class ParseXMLRenderXMLCheckTest {
    
    public ParseXMLRenderXMLCheckTest() {
    }
...
"                                    <layoutConstraint x=\"315\"\n" +
"                                    xsi:type=\"notation:Bounds\" y=\"93\"/>\n" +
"                                    </children>\n" +
"                                    <children type=\"4002 bw.xml.renderxml\">\n" +
"                                    <children type=\"4017\">\n" +
"                                    <styles\n" +
"                                    fontName=\"Segoe UI\"\n" +
"                                    lineColor=\"0\" xsi:type=\"notation:ShapeStyle\"/>\n" +
...
"        <bpws:variable element=\"ns1:xmlString\" name=\"ParseXml-input\" sca-bpel:internal=\"true\"/>\n" +
"        <bpws:variable name=\"ParseXml\" sca-bpel:internal=\"true\"/>\n" +
"        <bpws:variable element=\"ns2:ActivityErrorData\"\n" +
"            name=\"_error_ParseXml\" sca-bpel:internal=\"true\"/>\n" +
"        <bpws:variable element=\"ns:ErrorReport\" name=\"_error\" sca-bpel:internal=\"true\"/>\n" +
"        <bpws:variable name=\"RenderXml-input\" sca-bpel:internal=\"true\"/>\n" +
"        <bpws:variable element=\"ns3:xmlString\" name=\"RenderXml\" sca-bpel:internal=\"true\"/>\n" +
...
"        <bpws:flow name=\"flow\">\n" +
"            <bpws:links>\n" +
"                <bpws:link name=\"TimerToParseXml\" tibex:linkType=\"SUCCESS\"/>\n" +
"                <bpws:link name=\"ParseXmlToExit\" tibex:linkType=\"SUCCESS\"/>\n" +
"                <bpws:link name=\"RenderXmlToParseXml\" tibex:linkType=\"SUCCESS\"/>\n" +
"            </bpws:links>\n" +
...
"                    <bpws:sources>\n" +
"                        <bpws:source linkName=\"TimerToParseXml\"/>\n" +
"                    </bpws:sources>\n" +
"                    <tibex:eventSource>\n" +
"                        <bwext:BWActivity\n" +
...
"            </bpws:extensionActivity>\n" +
"            <bpws:extensionActivity>\n" +
"                <tibex:activityExtension inputVariable=\"ParseXml-input\"\n" +
"                    name=\"ParseXml\" outputVariable=\"ParseXml\"\n" +
"                    tibex:xpdlId=\"ec28532f-86f6-4e38-856b-33f8981597aa\" xmlns:tibex=\"http://www.tibco.com/bpel/2007/extensions\">\n" +
"                    <bpws:targets>\n" +
"                        <bpws:target linkName=\"RenderXmlToParseXml\"/>\n" +
"                    </bpws:targets>\n" +
"                    <bpws:sources>\n" +
"                        <bpws:source linkName=\"ParseXmlToExit\"/>\n" +
"                    </bpws:sources>\n" +
"                    <tibex:inputBindings>\n" +
"                        <tibex:inputBinding\n" +
"                            expression=\"&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?>&#xa;&lt;xsl:stylesheet xmlns:xsl=&quot;http://www.w3.org/1999/XSL/Transform&quot; xmlns:tns=&quot;http://www.tibco.com/namespaces/tnt/plugins/parsexml&quot; version=&quot;2.0&quot;>&lt;xsl:param name=&quot;RenderXml&quot;/>&lt;xsl:template name=&quot;ParseXml-input&quot; match=&quot;/&quot;>&lt;tns:xmlString>&lt;xsl:value-of select=&quot;$RenderXml&quot;/>&lt;/tns:xmlString>&lt;/xsl:template>&lt;/xsl:stylesheet>\" expressionLanguage=\"urn:oasis:names:tc:wsbpel:2.0:sublang:xslt1.0\"/>\n" +
"                    </tibex:inputBindings>\n" +
"                    <tibex:config>\n" +
"                        <bwext:BWActivity\n" +
...
"                <bpws:targets>\n" +
"                    <bpws:target linkName=\"ParseXmlToExit\"/>\n" +
"                </bpws:targets>\n" +
"            </bpws:exit>\n" +
"            <bpws:extensionActivity>\n" +
"                <tibex:activityExtension inputVariable=\"RenderXml-input\"\n" +
"                    name=\"RenderXml\" outputVariable=\"RenderXml\"\n" +
"                    tibex:xpdlId=\"ceca179c-931b-44c5-909c-53ef092b219c\" xmlns:tibex=\"http://www.tibco.com/bpel/2007/extensions\">\n" +
"                    <bpws:targets>\n" +
"                        <bpws:target linkName=\"TimerToParseXml\"/>\n" +
"                    </bpws:targets>\n" +
"                    <bpws:sources>\n" +
"                        <bpws:source linkName=\"RenderXmlToParseXml\"/>\n" +
"                    </bpws:sources>\n" +
"                    <tibex:config>\n" +
"                        <bwext:BWActivity\n" +
...
"                                    <value outputStyle=\"text\" xsi:type=\"palettexml:RenderXml\"/>\n" +
"                                </properties>\n" +
"                            </activityConfig>\n" +
"                        </bwext:BWActivity>\n" +
"                    </tibex:config>\n" +
...
"</bpws:process>");
    ...
    public void testValidate() {
        ...
        ParseXMLRenderXMLCheck instance = new ParseXMLRenderXMLCheck();
        ParseXMLRenderXMLCheck spyInstance = Mockito.spy(instance);
