...
public class SapFileSinkFileCountHardcodingCheckTest extends TestCase {
    ...
    public void testValidateXmlNoPassword() {
        ...
        SapFileSinkFileCountHardcodingCheck instance = new SapFileSinkFileCountHardcodingCheck();
        SapFileSinkFileCountHardcodingCheck spyInstance = Mockito.spy(instance);
