...
public class SapRPCClientSubjectHardcodingCheckTest extends TestCase {
    ...
    public void testValidateXmlNoPassword() {
        ...
        SapRPCClientSubjectHardcodingCheck instance = new SapRPCClientSubjectHardcodingCheck();
        SapRPCClientSubjectHardcodingCheck spyInstance = Mockito.spy(instance);
    ...
    public void testValidateXmlHarcoded() {
        ...
        spyInstance.validate(source);
        Mockito.verify(source,times(2)).reportOnIssue(any(),anyInt(),anyString());
    }
}