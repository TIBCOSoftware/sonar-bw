...
public class DeadProcessCheckForSubProcessTest extends TestCase {
    ...
    public void testValidate() {
        ...
        DeadProcessCheckForSubProcess instance = new DeadProcessCheckForSubProcess();
        DeadProcessCheckForSubProcess spyInstance = Mockito.spy(instance);
