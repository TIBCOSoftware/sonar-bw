...
public class HardCodedJndiUserCheckTest extends TestCase {
    ...
    public void testValidateXmlNoPassword() {
        ...
        HardCodedJndiUserCheck instance = new HardCodedJndiUserCheck();
        HardCodedJndiUserCheck spyInstance = Mockito.spy(instance);
