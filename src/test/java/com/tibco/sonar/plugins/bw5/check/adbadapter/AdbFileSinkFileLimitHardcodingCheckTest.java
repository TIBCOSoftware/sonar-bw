...
public class AdbFileSinkFileLimitHardcodingCheckTest extends TestCase {
    ...
    public void testValidateXmlNoPassword() {
        ...
        AdbFileSinkFileLimitHardcodingCheck instance = new AdbFileSinkFileLimitHardcodingCheck();
        AdbFileSinkFileLimitHardcodingCheck spyInstance = Mockito.spy(instance);
