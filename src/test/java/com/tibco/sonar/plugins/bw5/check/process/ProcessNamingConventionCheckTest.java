...
public class ProcessNamingConventionCheckTest extends TestCase {
    ...
    public void testValidateOK() {
        ProcessSource source = new ProcessSource("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "    <pd:name>ProcessDefinition.process</pd:name>\n" +
        ...
        ProcessNamingConventionCheck instance = new ProcessNamingConventionCheck();
        instance.setRegExpPattern("([A-z0-9])+\\.process");
        ProcessNamingConventionCheck spyInstance = Mockito.spy(instance);
